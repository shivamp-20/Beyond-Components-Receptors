...
class SimpleDataset:
    ...
    def __getitem__(self, i: int) -> Dict:
        ...
        return {
            ...
            "label_clean_str": ex.label_clean_str,
            "label_corr_str": ex.label_corr_str,
            "wrong_clean_str": ex.wrong_clean_str,
            "wrong_corr_str": ex.wrong_corr_str,
...
def collate_fn(batch: List[Dict]) -> Dict:
    ...
    return {
        ...
        "label_clean_str": [b["label_clean_str"] for b in batch],
        "label_corr_str": [b["label_corr_str"] for b in batch],
        "wrong_clean_str": [b["wrong_clean_str"] for b in batch],
        "wrong_corr_str": [b["wrong_corr_str"] for b in batch],
